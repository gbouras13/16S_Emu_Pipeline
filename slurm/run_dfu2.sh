...
#SBATCH --job-name=DFU_06_09_22
#SBATCH --mail-user=george.bouras@adelaide.edu.au
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --err="DFU_06_09_22.err"
#SBATCH --output="DFU_06_09_22.out"
...
--config csv=dfu_2.csv Output=/hpcfs/users/a1667917/Sha/DFU_06_09_22/Output Emu_DB=/hpcfs/users/a1667917/Emu_DB
