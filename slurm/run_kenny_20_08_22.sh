...
#SBATCH --job-name=16S_Kenny_20_08
#SBATCH --mail-user=george.bouras@adelaide.edu.au
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --err="16S_Kenny_20_08_snk.err"
#SBATCH --output="16S_Kenny_20_08_snk.out"
...
--config csv=kenny_20_08_metadata.csv Output=/hpcfs/users/a1667917/Kenny/20_08_Output Emu_DB=/hpcfs/users/a1667917/Emu_DB
